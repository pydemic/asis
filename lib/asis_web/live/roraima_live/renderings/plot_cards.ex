defmodule AsisWeb.RoraimaLive.Renderings.PlotCards do
  @moduledoc """
  ...
  defp incidence_ratio_map_card(%{params: params} = assigns) do
  ...
  defp incidence_ratio_chart_card(%{params: params} = assigns) do
    default_tooltip = "Doença ou agravo dividido por população residente multiplicado por 100.000"
    ...
    <div class="uk-width-1-3@l">
      <div class="uk-card uk-card-hover uk-card-default">
        <div class="uk-card-header" uk-tooltip="<%= tooltip %>">
          <h3 class="uk-card-title uk-text-center">Taxa de Incidência por Doença ou Agravo</h3>
        </div>
  ...
  defp incidence_chart_card(%{params: params} = assigns) do
    ...
    <div class="uk-width-1-3@l">
      <div class="uk-card uk-card-hover uk-card-default">
        <div class="uk-card-header" uk-tooltip="<%= tooltip %>">
          <h3 class="uk-card-title uk-text-center">Incidência por Doença ou Agravo</h3>
        </div>
