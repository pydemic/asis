defmodule Asis.Repo.Migrations.CreateMesoregions do
  ...
  def change do
    ...
    create index(:mesoregions, [:world_id])
    create index(:mesoregions, [:continent_id])
    create index(:mesoregions, [:country_id])
    create index(:mesoregions, [:region_id])
    create index(:mesoregions, [:state_id])
  end
end
